...
from policy.meta_trpo import MetaTRPO_Learner
...
class HIHA_Algorithm(nn.Module):
    def __init__(self, env, logger, writer, args):
        super(HIHA_Algorithm, self).__init__()
    ...
    def begin_training(self):
        ...
        trainer = Trainer(
            ...
            writer=self.writer,
            init_timesteps=self.current_timesteps,
            timesteps=int(self.args.timesteps / 10),
            log_interval=self.args.log_interval,
            eval_num=self.args.eval_num,
            seed=self.args.seed,
        )
